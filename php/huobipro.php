...
class huobipro extends Exchange {
    ...
    public function _websocket_dispatch ($contextId, $data) {
        ...
        if ($channel === 'depth') {
            ...
            // $data:
            // array('ch' => 'market.btchusd.trade.detail', 'ts' => 1551962828309, 'tick' => array('id' => 100123237799, 'ts' => 1551962828291, 'data' => [array('amount' => 0.435, 'ts' => 1551962828291, 'id' => 10012323779926186502443, 'price' => 3871.72, 'direction' => 'sell')]))
